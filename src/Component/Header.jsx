    ...
    <header className="bg-gray-100">
        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="flex md:order-2 ">
            ...
            <div className=" md:w-60 hidden   invisible md:visible sm:flex  flex-col place-items-left">
              <span className="font-bold  md:text-md">
                Deliver to{" "}
                <span className=" font-normal cursor-pointer underline hover:text-gray-900 text-green-700">
                  Name
                </span>
              </span>
              <span className=" font-normal cursor-pointer text-sm underline hover:text-gray-900 text-green-700">
                {" "}
                Location
              </span>
            </div> */}
            ...
            <a
              href="#_"
              className="relative rounded px-5 py-2.5 overflow-hidden group bg-green-600 relative hover:bg-gradient-to-r hover:from-green-700 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300"
            >
          ...
          <div className=" md:w-full  h-[100%] hidden cursor-pointer max-w-xs  md:max-w-xl xl:max-w-3xl 2xl:max-w-5xl  border-[0.5px] border-gray-900 border-opacity-50 rounded-md  xl:flex items-center">
            <div className="  rounded-l-md  text-white ">
              <select className=" uppercase bg-gray-800 pr-5 rounded-l-md font-bold text-sm p-[0.70rem]  mr-2">
      ...
      <nav className="bg-gray-900 text-white text-xs sm:text-sm md:text-sm  lg:text-sm font-medium ">
        <div className="container flex items-center text-center  justify-center py-5 mx-auto  capitalize ">
          ...
          >
            <a href="#" className=" border-b-2 border-green-500 mx-3 sm:mx-6">
              Home
            </a>
          </motion.div>
          <motion.div
          ...
          >
            <a
              href="#"
              className="border-b-2 border-transparent hover:text-gray-400  hover:border-green-500 mx-3 sm:mx-6"
            >
              About Us
            </a>
          </motion.div>
          ...
          >
            <a
              href="#"
              className="border-b-2 border-transparent text-center hover:text-gray-400  hover:border-green-500 mx-3 sm:mx-6"
            >
              {" "}
              Blogs{" "}
            </a>
      ...
      {/* <div className="container flex justify-center mx-auto px-4 py-3 flex items-center">
        ...
        <div className=" md:w-60 hidden invisible md:visible sm:flex  flex-col place-items-left">
          ...
          <span className=" font-normal cursor-pointer text-sm underline text-green-700">
            {" "}
            Location
          </span>
        </div>
