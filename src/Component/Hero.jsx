...
const Hero = () => {
  return (
    <section className=" bg-gray-900 relative  border-b-[6px]  border-green-400 ">
      <div className="grid max-w-screen-2xl px-10 md:px-10  mx-auto lg:gap-8 xl:gap-0  lg:grid-cols-12">
        <div className="mr-auto place-self-start lg:col-span-7  font-semibold">
          <h1 className="max-w-2xl py-20 mb-4 font-semibold text-2xl md:font-bold tracking-tight leading-none md:text-4xl xl:text-5xl 2xl:text-6xl text-green-500">
            ...
            <p className="max-w-2xl text-base font-normal -mb-16 font-light text-gray-400  md:text-lg lg:text-xl ">
          ...
          <a
            href="#_"
            className="relative inline-flex  items-center px-2 mb-20 py-2 md:px-7  md:pl-5 md:py-3 overflow-hidden text-lg font-medium text-green-600 border-2 border-green-600 rounded-lg hover:text-white group hover:bg-gray-50"
          >
            ...
            <span  className="absolute right-0 flex items-center justify-start w-10 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
              <svg
                className="w-5 invisible md:visible h-5 ml-4 "
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <span className="relative text-sm md:text-base  text-white">Explore Now</span>
          </a>
        </div>
        <div className="hidden  ml-10 mx-3 xl:mx-0 sm:mx-3  lg:mx-3 grid-cols-12 lg:mt-0  flex  justify-end  lg:col-span-5 lg:flex">
          ...
          <div className="ml-3">
            <div className="w-[14rem] h-[10rem] -mt-[3.7rem] flex mb-3 rounded-lg border-t-0 rounded-t-none border-gray-100 border-[3px]">
              <img src={Hero3} className=""></img>
            </div>
            <div className="w-[14rem] h-[18rem] flex mb-3 rounded-lg  border-gray-100 border-[3px]">
              {" "}
